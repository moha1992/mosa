...
client.on('ready', () => {
  client.user.setGame(` WLC #4272 .`,'https://www.twitch.tv/v5bz');
  console.log('---------------');
...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("***id**","**لـ معلومات عن الحساب**")
      .addField("***اقتراح :newspaper:**","**لأضافة اقتراحك للادارة**")
      .addField("***server :recycle:**","**لـ معلومات السيرفر**")
      .addField("***roles :medal: **","**لـ رؤية رتب السيرفر**")
.setColor('RANDOM')
          ...
          .then(co => {
            text = co.first().content
              ...
              message.channel.send(`تم حفظ اقتراحك الرجاء انتضار الرد من قبل الاداره`)
                client.channels.get("522750131653705771").send(`${message.author.username}'s sug => ${text}`)
...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("***giveaway :tada:**","**لـ عمل قيف اواي**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
.setThumbnail(message.author.avatarURL)    
	  ...
	  .addField("** :tools:  تحت الصيانة حاليا**","** **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
if (message.content === '*help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: Mohamed Keshk|✙ŁĢĐ™#3900  **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.on('message', message => {
    if (message.content == "*ask") {
        ...
        message.channel.send(`📢 امامك دقيقة لحل السؤال التالي :  __**${x[x3]}**__ `).then(msg1=> {
...
client.on('message', message => {
    if (message.content == "*فكك") {
         message.react('🤔','👌')
        var x = ['اف ثري', 'فيني وسن', 'مسجون', 'ببسي دايت', 'استرداد'
        ];
        var x2 = ['ا ف ث ر ي', 'ف ي ن ي و س ن', 'م س ج و ن', 'ب ب س ي د ا ي ت', 'ا س ت ر د ا د'
        ];
		var x3 = Math.floor(Math.random()*x.length)
        message.channel.send(`📢 أمامك 5 ثواني لتفكيك الجملة التالية :  __**${x[x3]}**__ `).then(msg1=> {
            var r = message.channel.awaitMessages(msg => msg.content == x2[x3], {
               thing: true,
               maxMatches : 1,
                time : 5000,
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`WLC`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : WLC ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(` WLC *help`,"http://twitch.tv/S-F")
...
client.on('message',function(message) {
    let w = ['انا اخترت حجرة','انا اخترت ورقة','انا اخترت مقص'];
